...
class MinSleepDurationAnalyzerTest {
    ...
    void zeroWhenEmptyList() {
        assertEquals(0L, new MinSleepDurationAnalyzer()
                .apply(List.of())
                .value());
    }
    ...
    void singleSession() {
        ...
        // 8h15 = 495 мин
        assertEquals(495L, new MinSleepDurationAnalyzer()
                .apply(sessions)
                .value());
    }
    ...
    void minAmongMany() {
        ...
        assertEquals(50L, new MinSleepDurationAnalyzer()
                .apply(sessions)
                .value());
    }
    ...
    void correctDescription() {
        assertEquals("Минимальная продолжительность сна в минутах", new MinSleepDurationAnalyzer()
                .apply(List.of())
                .description());
    }
}